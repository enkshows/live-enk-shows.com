<?php 
  ...
  include($root . '/includes/ic/2016/jan/ic-jan2016-vars.php'); 
...
<div id="wrapper">
  ...
  <div id="main-col">
    ...
    <!-- Roster -->     
    <?php include($root . '/includes/ic/2016/jan/ic-jan2016-roster.php'); ?> 

    <!-- Floorplans -->     
    <?php include($root . '/includes/ic/2016/jan/ic-jan2016-floorplan.php'); ?> 
