<?php 
  ...
  include($root . '/includes/ac/2016/jan/ac-jan2016-vars.php'); 
...
<div id="wrapper">
 ...
 <!-- Navigation--> 
  ...
  <div id="main-col">
    ...
    <!-- Show Descriptions -->
    <?php include($root . '/includes/ac/2016/jan/ac-2016-show-description.php'); ?>

    <!-- AC Forms -->
    <?php include($root . '/includes/ac/2016/jan/ac-2016-forms.php'); ?>  
    
    <!-- Highlights -->     
    <?php include($root . '/includes/ac/2016/jan/ac-jan2016-highlights.php'); ?> 

    <!-- Roster -->     
    <?php include($root . '/includes/ac/2016/jan/ac-jan2016-roster.php'); ?> 
    
    <!-- Floorplans -->     
    <?php include($root . '/includes/ac/2016/jan/ac-jan2016-floorplan.php'); ?> 
