...
DEFINE('MATHGUARD_COLOR', "#343434");
DEFINE('MATHGUARD_SIZE', 5);
DEFINE('MATHGUARD_LINEHEIGHT', 4);
DEFINE('MATHGUARD_QUESTION', "Verification check");
...
class MathGuard {
	...
	function produceOutput($prime) {
		...
		$output = '<b>' . MATHGUARD_QUESTION . '</b>' .
		"<table border='0'><tr><td style='font-family: monospace; font-size:" . MATHGUARD_SIZE . "px; font-weight: bold; color: " . MATHGUARD_COLOR . "; padding:0px; margin: 0px; line-height:" . MATHGUARD_LINEHEIGHT . "px;'>\n\n" . MathGuard :: renderExpression($a, $b) . "</td>
				<td><input type='input' name='".MATHGUARD_FIELD_ANSWER."' value=\"Answer?\" size='2' maxlength='2'/><input type='hidden' name='".MATHGUARD_FIELD_CODE."' value='$code' /></td>
				</tr>
				</table>
				";
