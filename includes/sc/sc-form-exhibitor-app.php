<div id="form2" class="form2 formhide">
  ...
  <div class="desc-lg">
    ...
    If you have questions during this process, please contact <a href="mailto:bpina@advanstar.com">bpina@advanstar.com</a> or call 310.857.7661.
  </div>
    ...
    <div id="showApply_form">
      <form id="showApplyForm" method="post" action="../bin/applyForm.php" class="form">
        <fieldset>
          ...
          <div class="captcha">
            <div class="enkCaptcha" id="scExhibitorFormCaptcha"></div>
          </div>
        </fieldset>
