...
<div class="module-content-info">
  ...
  <?php include($root . '/includes/ev/ev-form-exhibitor-app.php'); ?>

  <?php include($root . '/includes/ev/ev-form-visit.php'); ?>

  <?php include($root . '/includes/ev/ev-form-contact.php'); ?>

  <?php include($root . '/includes/ev/2015/ev-2015-shows.php'); ?>
