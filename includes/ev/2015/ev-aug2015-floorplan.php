  ...
  <div class="module-content">
    <div class="showcol-l">
      ...
      <div id="btn1" class="showcol-btn2">
        <a href="<?php echo PDF_EV; ?>2015/feb/vegas-feb2015_exhibitormap.pdf" target="_blank" class="showcol-link">Detailed Floor Plan</a>
      </div>
    </div>

    <div id="floorplans-content">
      <div id="floorplans-content1" class="showcol-content">
        <a href="<?php echo PDF_EV; ?>2015/feb/vegas-feb2015_exhibitormap.pdf" target="_blank">
          <img src="<?php echo IMG_EV; ?>2014/feb/vegas-feb2014-floorplan.png" border="0">
        </a>
      </div>
