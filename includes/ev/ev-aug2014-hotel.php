<div id="hotel-travel" class="module">
  ...
  <div class="module-content">
      <div class="showcol-l">
        ...
        <div id="btn2" class="showcol-btn3">Taxis, Car & Shuttle Service</div>
        <div id="btn3" class="showcol-btn3">From M<span style="text-transform:lowercase;">c</span>CARRAN AIRPORT</div>
        <div id="btn4" class="showcol-btn3">Parking - Mandalay Bay</div>
        <div id="btn5" class="showcol-btn3 ">Show Hours/Location</div>
      </div>
      <div id="concierge-content">
        
        <div id="concierge-content1" class="showcol-content"> 
          <p>For exclusive hotel discounts and reservations, please click <a href="https://www.tphousing.com/r2/index_new.aspX?EICode=2893&Attcode=1330&WebSessionsResID=21844924" target="new"><strong>Attendees</strong></a>
           or <a href="https://www.tphousing.com/r2/index_new.aspX?EICode=2893&Attcode=1330&WebSessionsResID=21844924" target="new"><strong>Exhibitors</strong></a>.</p><br>
        </div>
