...
<div class="module-content-info">
  ...
  <?php include($root . '/includes/fc/fc-form-exhibitor-app.php'); ?>

  <?php include($root . '/includes/fc/fc-form-visit.php'); ?>

  <?php include($root . '/includes/fc/fc-form-contact.php'); ?>

  <?php include($root . '/includes/fc/2016/sept/fc-2016-shows.php'); ?>
