    ...
    <div id="concierge-content">
      <div id="concierge-content1" class="showcol-content">
        ...
        <div class="hotel bg-vendor-hudson">
          <a class="overlay" href="https://www.morganshotelgroup.com/special/hudson-coterie-2014" target="_blank">
            <span class="attend-show hotel-name">Hudson Hotel</span>
            <span class="attend-date hotel-details">Exclusive Rates for Coterie September 2014</span>
          </a>
        </div>
        <br>
        <h3>Other NYC Hotels</h3>
        For additional hotel discounts and reservations, please click <a href="http://www2.quikbook.com/event/enkfashion2014.asp?incentivecode=ENKFASHIONATT&utm_source=ENKFASHION&utm_medium=site&utm_content=ENKFASHIONATT&utm_campaign=qbprivatelabelsite">Attendees</a> or <a href="http://www2.quikbook.com/event/enkfashion2014.asp?incentivecode=ENKFASHIONEXH&utm_source=ENKFASHION&utm_medium=site&utm_content=ENKFASHIONEXH&utm_campaign=qbprivatelabelsite">Exhibitors</a>.
      </div>
      ...
      <div id="concierge-content5" class="showcol-content">
        ...
        Up to 12 hrs - $20<br>
        Up to 24 hrs - $45<br>
        <a class="red" href="https://www.mpsparking.com/print-specialcoupon.php?id=48" target="_blank">See featured Parking Coupon</a><br><br>
      ...
      <div id="concierge-content6" class="showcol-content">
        ...
        <div class="manual-r">
          ...
          <span class="book">
            Sunday, September 14 / 9AM - 6PM<br>
            Monday, September 15 / 9AM - 6PM<br>
            Tuesday, September 16 / 9AM - 5PM<br><br>
          </span>
        </div>
        <iframe width="520" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="<?php echo BASE; ?>/maps/javits.html"></iframe> <br />
      </div>
    </div>
