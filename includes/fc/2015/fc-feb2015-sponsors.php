 <!-- 
to update with new images make sure 
to go on the server: img/vendors
then upload there
 -->
<div id="sponsors" class="module">
  <h1>Sponsors</h1>
  <div class="module-content" style="margin-top:0;">
    <div class="imagePressBox sponsors-box">
      ...
      <div class="element fc-sponsor" >   
        <a href="http://doublecrossvodka.com/" target="_blank">
        <img src="<?php echo VENDORS; ?>/cornell.png">  
        </a>
      </div>
      <div class="element fc-sponsor" >   
        <a href="http://www.cornell.edu/" target="_blank">
        <img src="<?php echo VENDORS; ?>/double-cross.png">  
        </a>
      </div>
      ...
      <div class="element fc-sponsor" >   
        ...
        <img src="<?php echo VENDORS; ?>/isko.png" height="100">  
        </a>
      </div>
      <div class="element fc-sponsor" >   
        <a href="http://www.jonathanadler.com/" target="_blank">
      ...
      <div class="element fc-sponsor" >   
        <a href="http://www.australianfashionlabels.com.au" target="_blank">
