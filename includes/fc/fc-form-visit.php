<div id="form5" class="form5 formhide">
  ...
  <div class="desc-lg">
    ...
    If you have questions during this process, please contact <a href="mailto:fashioncoterie@enkshows.com">fashioncoterie@enkshows.com</a> or call 212.951.6600.
  </div>
      ...
      <div id="visitor_form">
        <form id="visitorForm" method="post" action="../bin/visitorForm.php" class="form">
          <fieldset>
            ...
            <div class="captcha">
              <div class="enkCaptcha" id="fcVisitFormCaptcha"></div>
            </div>
          </fieldset>
