  ...
  <div class="module-content">
    ...
    <div class="showcol-l">
      ...
      <div id="btn1" class="showcol-btn2">
        <a href="<?php echo PDF_CHILDRENS; ?>2014/aug/cc-aug2014-exhibitor_map.pdf" target="_blank" class="showcol-link">Detailed Floor Plan</a>
      </div>
    </div>

    <div id="floorplans-content">
      <div id="floorplans-content1" class="showcol-content">
        <a href="<?php echo PDF_CHILDRENS; ?>2014/aug/cc-aug2014-exhibitor_map.pdf" target="_blank">
          <img src="<?php echo IMG_CHILDRENS; ?>2014/aug/pier94-solo.png" width="520" border="0">
        </a>
      </div>
