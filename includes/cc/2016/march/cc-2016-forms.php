<div class="module-content-info">
  <div class="info-links">
    ...
    <a href="http://advanstar.force.com/childrensclub?tag=CLB161-0-5-103" class="info-btn" target="_blank">Attend</a>
...
<div class="module-content-info">
  ...
  <?php include($root . '/includes/cc/cc-form-exhibitor-app.php'); ?>

  <?php include($root . '/includes/cc/cc-form-visit.php'); ?>

  <?php include($root . '/includes/cc/cc-form-contact.php'); ?>

  <?php include($root . '/includes/cc/2016/march/cc-2016-shows.php'); ?>
