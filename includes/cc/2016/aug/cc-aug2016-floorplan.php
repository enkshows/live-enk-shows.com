  ...
  <p> To view and/or download a detailed floor plan, click the links on the left or on the desired venue or venue level from the image.  
    ...
    <div class="row">
      <nav class="row-item item-one-third">
        ...
        <a class="showcol-link" target="floorplan" href="http://www.enkshows.com/pdf/childrensclub/2016/aug/cc-aug2016-exhibitor-map.pdf">Detailed Floor Plan</a>
      ...
      <a href="<?php echo PDF_CHILDRENS; ?>2016/aug/cc-aug2016-exhibitor-map.pdf" target="_blank" border="0">
        <img src="<?php echo IMG_CHILDRENS; ?>/2016/march/cc-march2016-level2.png" border="0">
      </a>
      <a href="<?php echo PDF_CHILDRENS; ?>2016/aug/cc-aug2016-exhibitor-map.pdf" target="_blank" border="0">
        <img src="<?php echo IMG_CHILDRENS; ?>/2016/aug/javits_aug16-lv1.png" border="0">
      </a>
      </div>  
    </div>
</div>
