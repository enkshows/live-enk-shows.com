    ...
    <div id="concierge-content">
      <div id="concierge-content1" class="showcol-content">
        ...
        <div class="hotel bg-vendor-hudson">
          <a class="overlay" href="https://www.morganshotelgroup.com/special/hudson-accessories-circuit-intermezzo-collection" target="_blank">
            <span class="attend-show hotel-name">Hudson Hotel</span>
            <span class="attend-date hotel-details">Exclusive Rates for Children's Club August 2014</span>
          </a>
        </div><br><br>
        <h3>Other NYC Hotels</h3><br>
        For additional hotel discounts and reservations, please click <a href="http://www2.quikbook.com/event/enkcclub-august.asp?incentivecode=ENKCCLUBATT&utm_source=ENKCCLUB&utm_medium=site&utm_content=ENKCCLUBATT&utm_campaign=qbprivatelabelsite" target="_blank">Attendees</a> or <a href="http://www2.quikbook.com/event/enkcclub-august.asp?incentivecode=ENKCCLUBEXH&utm_source=ENKCCLUB&utm_medium=site&utm_content=ENKCCLUBEXH&utm_campaign=qbprivatelabelsite" target="_blank">Exhibitors</a>.
      </div>
      ...
      <div id="concierge-content6" class="showcol-content">
        ...
        <div class="manual-r">
          ...
          <span class="book">
            Sunday, August 3 / 9am-6pm<br>
            Monday, August 4 / 9am-6pm<br>
            Tuesday, August 5 / 9am-5pm<br><br></br>
          </span>
        </div>
