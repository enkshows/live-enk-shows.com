<div id="form3" class="form3 formhide">
 <h2>Contact</h2>
 <div class="desc-lg">
  Please feel free to communicate with one of our <? echo $showname;?> show team members by completing the brief form below. 
...
<div class="module-content">
  ...
  <div id="contact_form">
    ...
    <form id="contactForm" method="post" action="../bin/contactForm.php" class="form">
      <fieldset>
        <div class="formcol-l" >
          <input type="hidden" class="showName" name="showName" value="FWD"> 
        ...
        <div class="formcol-r" >
          <select name="InquiryType" class="inquiry text-input required" tabindex="602">
            ...
            <option value="FWD"><?echo $showname;?> SHOW TEAM</option>
          </select><br>
        ...
        <div class="captcha">
          <div class="enkCaptcha" id="fwdContactFormCaptcha"></div>
        </div>
