...
<div class="module-content-info">
  ...
  <?php include($root . '/includes/ic/ic-form-exhibitor-app.php'); ?>

  <?php include($root . '/includes/ic/ic-form-visit.php'); ?>

  <?php include($root . '/includes/ic/ic-form-contact.php'); ?>

  <?php include($root . '/includes/ic/2016/jan/ic-2016-shows.php'); ?>
