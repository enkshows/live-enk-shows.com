...
<div class="module-content-info">
  ...
  <?php include($root . '/includes/ac/ac-form-exhibitor-app.php'); ?>

  <?php include($root . '/includes/ac/ac-form-visit.php'); ?>

  <?php include($root . '/includes/ac/ac-form-contact.php'); ?>

  <?php include($root . '/includes/ac/2016/may/ac-2016-shows.php'); ?>
